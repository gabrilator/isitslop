		...
		<div class="flex-1 overflow-y-auto p-3">
			...
			{:else}
				{#if slopGroups.length > 0}
					<h3 class="mb-2 px-1 font-mono text-[10px] uppercase tracking-widest text-ink/40">
						{t.slopFlags}
					</h3>
				...
				{#if tipGroups.length > 0}
					<h3 class="mb-2 mt-2 px-1 font-mono text-[10px] uppercase tracking-widest text-ink/40">
						{t.writingTips}
					</h3>
					<ul class="space-y-2">
